...
(function (global, factory) {
    ...
    var CardWidget = /*#__PURE__*/function () {
        ...
        _proto.maximize = function maximize() {
            ...
            this._parent.css({
                height: this._parent.height(), width: this._parent.width(), transition: 'all .15s'
    ...
    var ControlSidebar = /*#__PURE__*/function () {
        ...
        _proto._fixScrollHeight = function _fixScrollHeight() {
            ...
            if (positions.top === 0 && positions.bottom === 0) {
                $controlSidebar.css({
                    bottom: heights.footer, top: heights.header
                });
        ...
        _proto._fixHeight = function _fixHeight() {
            ...
            if (typeof $__default["default"].fn.overlayScrollbars !== 'undefined') {
                $controlSidebar.overlayScrollbars({
                    className: this._config.scrollbarTheme, sizeAutoCapable: true, scrollbars: {
                        autoHide: this._config.scrollbarAutoHide, clickScrolling: true
                    }
                });
            }
        } // Static
    ...
    var Dropdown = /*#__PURE__*/function () {
        ...
        _proto.fixPosition = function fixPosition() {
            ...
            if (offset.left < 0) {
                $element.css({
                    left: 'inherit', right: offset.left - 5
                });
    ...
    var Default$8 = {
        minimizeIcon: 'fa-compress-arrows-alt', maximizeIcon: 'fa-expand-arrows-alt'
    };
    /**
     * Class Definition
     * ====================================================
    ...
    var Default$5 = {
        autoCollapseSize: 992, enableRemember: false, noTransitionAfterReload: true, animationSpeed: 300
    };
    /**
     * Class Definition
     * ====================================================
    ...
    var SidebarSearch = /*#__PURE__*/function () {
        ...
        _proto._renderItem = function _renderItem(name, link, path) {
            ...
            var groupItemElement = $__default["default"]('<a/>', {
                href: decodeURIComponent(link), class: 'list-group-item'
            });
    ...
    var Default$3 = {
        resetOnClose: true, target: SELECTOR_SEARCH_BLOCK
    };
    /**
     * Class Definition
     * ====================================================
